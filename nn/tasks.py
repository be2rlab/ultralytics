...
from ultralytics.yolo.utils.loss import (
...
class BaseModel(nn.Module):
    ...
    def _profile_one_layer(self, m, x, dt):
        ...
        o = (
            thop.profile(m, inputs=[x.clone() if c else x], verbose=False)[0] / 1e9 * 2
            if thop
            else 0
        )  # FLOPs
        t = time_sync()
...
class ClassificationModel(BaseModel):
    ...
    def __init__(
        self, cfg=None, model=None, ch=3, nc=None, cutoff=10, verbose=True
