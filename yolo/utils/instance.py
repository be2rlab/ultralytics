...
class Bboxes:
    ...
    def convert(self, format):
        ...
        if self.format == format:
            ...
            bboxes = (
                xyxy2xywh(self.bboxes) if format == "xywh" else xyxy2ltwh(self.bboxes)
            )
        elif self.format == "xywh":
            bboxes = (
                xywh2xyxy(self.bboxes) if format == "xyxy" else xywh2ltwh(self.bboxes)
            )
        else:
            bboxes = (
                ltwh2xyxy(self.bboxes) if format == "xyxy" else ltwh2xywh(self.bboxes)
            )
        self.bboxes = bboxes
        self.format = format
